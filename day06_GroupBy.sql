...
/* ----------------------------------------------------------------------------
  ...
  yazınız.
-----------------------------------------------------------------------------*/ 
select urun_adi,max(urun_miktari)  max_sayi , min(urun_miktari) min_sayi from manav
where urun_adi is not null
group by urun_adi
order by max_sayi;
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
select isim, urun_adi,sum(urun_miktari) as toplam from manav
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/  
 select isim,urun_adi, sum(urun_miktari) miktar from manav
 group by isim,urun_adi
