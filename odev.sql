...
set hasta_isim='Salvadore Dali',hastane_adi='Jaohn Hopins',bolum_adi='Noroloji',teshis='Parkinson',kimlik_no='99991111222'
...
bolum_adi=(select bolum_id from Bolumler_tablosu where bolum_id='DHL'),
...
/*7-) hasta_kayıtlar tablosundaki ‘2222’ kimlik nolu kaydı aşağıdaki gibi güncelleyiniz.
...
bolum_adi=(select bolum_id from Bolumler_tablosu where bolum_id='KBB'),
